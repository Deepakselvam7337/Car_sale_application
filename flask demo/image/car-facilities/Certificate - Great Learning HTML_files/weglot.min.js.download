var Weglot = (function () {
  ...
  function h(e) {
    try {
      if (
        n.forceNoMergeSelector &&
        e.closest &&
        e.closest(n.forceNoMergeSelector)
      )
        return !1;
    } catch (e) {}
    return (
    ...
    return (
      ...
      Array.isArray(n.extra_merged_selectors) &&
        (n.selectorMerging = r.extra_merged_selectors
          ...
          .join(",")),
      r.parser_force_no_merge_selectors &&
  ...
  var z = d({ service: "js-library" }),
    ...
    ie = ["none", "shiny", "square", "circle", "rectangle_mat"],
    se = [
    ...
    le = ce("querySelectorAll", []),
    ue = ce("querySelector", null),
    de = ce("closest", null),
    fe = function (e) {
  ...
  var xe,
    Se = {};
  try {
    document.cookie, (xe = !0);
  } catch (e) {
    xe = !1;
  }
  (Se.set = function (e, t, n, r, a) {
    xe &&
      ((e = e
      ...
      !n && ft.is_connect && ft.subdomain && (n = ft.host.split("www.").pop()),
      (n = n ? ";domain=" + n : ""),
      (a = a ? ";expires=" + a : ""),
      (r = r || ""),
      (document.cookie =
    ...
    (Se.erase = function (e, t, n) {
      Se.set(e, "", t, n, "Thu, 01 Jan 1970 00:00:00 GMT");
    });
  var Le = [];
  function Ae(e, t, n) {
    if (e) return n();
  ...
  function Ne(e, t, n) {
    return "function" != typeof t
      ...
      : (Le.push({ name: e, callback: t, internal: n }), !0);
  }
  function Oe(e) {
    for (var t = [], n = arguments.length - 1; n-- > 0; )
      t[n] = arguments[n + 1];
    for (
      var r = Le.filter(function (t) {
          return t.name === e;
        }),
        a = 0,
        o = r;
  ...
  var je = Te();
  Ae(ft && Object.keys(ft).length > 0, "onOptionsReady", function () {
    if (ft.dynamicPushState) {
  ...
  function Pe() {
    ...
    return (
      (De.convertLocale = function (t, n, r, o) {
        if (
          (void 0 === n && (n = e),
          void 0 === r && (r = s || a),
          void 0 === o && (o = null),
        ...
        if (t === a && !u)
          return f
            ...
            .concat(f.slice(i + 2))
            .join("/");
        var _ = Re((t === a ? u : d).replace(/CODE/g, t)),
          b = g.replace(c, _);
        return f
          .slice(0, i + 1)
  ...
  function Me() {
    var e = je.hostname,
      t = ft.languages.find(function (t) {
        return (
          t.connect_host_destination && t.connect_host_destination.host === e
        );
      });
    return t ? t.custom_code || t.language_to : ft.language_from;
  }
  function qe() {
    return Pe().language;
  }
  function We() {
    ...
    if (ft.is_connect) {
      ...
      return e ? ((Ie = e), e) : (Ie = ft.subdirectory ? qe() : Me());
    }
    return (Ie = ft.language_from);
  }
  function ze(e, t) {
    var n = t;
    n || (n = We());
  ...
  function Fe(e) {
    ...
    var t = e.type || "local";
    try {
      return "cookie" === t ? Be : window.localStorage;
    } catch (e) {}
    return e.type ? Ue : Fe({ type: "local" === t ? "cookie" : "local" });
  }
  function He() {
    -1 !== location.search.indexOf("weglot-private=0") &&
      Fe().removeItem("wg-private-mode");
    var e =
      document.getElementById("admin-bar-iframe") ||
      document.getElementById("preview-bar-iframe") ||
      !0 === ft.switcher_editor ||
      -1 !== location.search.indexOf("weglot-private=1") ||
      "1" === Fe().getItem("wg-private-mode") ||
      window.location.hostname === $;
    return e && Fe().setItem("wg-private-mode", "1"), e;
  }
  var $e = { slugs: {}, version: 0, network: void 0 };
  function Ge() {
  ...
  function Ye(e) {
    ...
    if (t && t.slugTranslation) {
      ...
      $e.version < n &&
        ($e.network
          ? $e.network.resolved ||
            $e.network.then(function (t) {
              return e(Je(t));
            })
          : ($e.network = Ge().then(function (t) {
              return (
                ($e.network.resolved = !0),
                (function (e) {
                  var t = ft.versions,
                    n = { version: t ? t.slugTranslation : 1, slugs: e };
                  try {
                    var r = Fe({ type: "local" });
                    r && r.setItem(J, JSON.stringify(n));
                  } catch (e) {
                    z.warn(e);
                  }
                  $e = Object.assign({}, $e, n);
  ...
  !(function () {
    if (Object.keys($e.slugs).length) return $e.slugs;
    try {
      var e = Fe({ type: "local" });
      if (!e) return {};
      var t = e.getItem(J);
      t && (Object.assign($e, JSON.parse(t)), $e.slugs);
    } catch (e) {
      return {};
    }
  })();
  ...
  function Qe(e, t) {
    ...
    var a = (function (e) {
      if (ft.subdirectory) return !1;
      var t = ft.language_from,
        n = ft.host,
        r = ft.languages;
      if (e === t) return n;
      var a = (
    ...
    return (
      ...
      (r.pathname = (function (e, t, n, r) {
        ...
        if (!Ve.originalPath)
          if (n !== ft.language_from && e[n]) {
            var a = e[n].translated;
            Ve.originalPath = Ke(t, a);
          } else Ve.originalPath = t;
        return r === ft.language_from
          ? Ve.originalPath
          : e[r] && e[r].original
          ? Ke(Ve.originalPath, e[r].original)
          : t;
      })(t, r.pathname, n, e)),
      ft.subdirectory &&
        e &&
        (r.pathname = (function (e, t) {
          return Pe().convertLocale(e, t);
        })(e, r.pathname)),
      r.toString()
    );
  }
  function Xe(e, t) {
    if (!ft.is_connect || !e) return t("#");
    Ye(function (n) {
      return t(Qe(e, n));
    });
  }
  ...
  var Ze = {};
  function et(e, t) {
    return ft.is_connect && e !== ft.language_from
      ? Ze[t]
        ? Ze[t]
        : (Ye(function (r) {
            var a = r && r[e] ? Ke(t, r[e].original) : t;
            n = ft.subdirectory
              ? Pe().convertLocale(e, a, ft.language_from)
              : a;
          }),
          (Ze[t] = n),
          n)
  ...
  function rt(e, t) {
    if ((void 0 === t && (t = ""), !e)) return oe.button_style;
    var n = e.classF || "",
      r = n.match(/flag-(\d)/),
      a = {
  ...
  function at(e) {
    var t = e.styleOpt,
      ...
      r = e.target,
      a = e.sibling;
    return { style: rt(t, n), location: { target: r, sibling: a } };
  }
  (tt[Y] = function () {
    var e = function (e) {
        void 0 === e && (e = We());
        for (
          ...
          (0 === s.indexOf(t("/cart")) && s.split("?")[0] !== t("/cart")) ||
            i.setAttribute("action", ye(s, "locale", r));
        }
        for (
          var c = 0,
          ...
          var u = l[c];
          u.setAttribute("href", ye(u.getAttribute("href"), "locale", r));
        }
      },
      t = function (e) {
        void 0 === e && (e = We());
        var t =
          ...
          document.querySelector('form[action="' + et(e, "/account") + '"]') ||
          ("string" == typeof ft.customer_tag && ue(document, ft.customer_tag));
        if (t) {
    ...
    function o(o) {
      if (ft.language_from !== o) {
        var i, s;
        window.Shopify && (window.Shopify.locale = o),
          !ve() && ft.order_tag && a(o),
          e(o),
          (i = o),
          (s = r()) && Se.set("checkout_locale", n(i), null, s);
        var c = document.querySelectorAll("[data-wg-only-display]");
        c.length && ze(c, o), ft.customer_tag && t(o);
      }
    }
    Ne(
      "initialized",
              ...
              if ("/wallets/checkouts.json" === arguments[0])
                try {
                  ...
                  (e.checkout.attributes = {}),
                    ft.cart_attributes.forEach(function (n) {
      ...
      Ce("onConnectPageLoad", function (e) {
        return o(e);
      }),
      Ce("onPageLanguageSet", function (e) {
        return o(e);
      }),
      Ce("onDynamicDetected", function () {
        e(We());
      }),
      Ce("startWhen", function () {
        return (
          fe("admin-bar-iframe") ||
        ...
        Ce("onPageLanguageSet", function (e) {
          !(function (e) {
            for (
              ...
              var r = n[t];
              r.setAttribute("href", ye(r.getAttribute("href"), "lang", e));
            }
          })(e);
        }),
        {
    ...
    (tt[te] = function () {
      return ft.is_connect ? {} : { dynamics: [{ value: ".content" }] };
    }),
    (tt[K] = function () {
      return {
        excluded_blocks: [
    ...
    (tt[Q] = function () {
      ...
      return {
        ...
        parser_force_no_merge_selectors: [{ value: ".plyr__menu__container" }],
      };
    }),
    (tt[X] = function () {
      var e = {
    ...
    (tt[ne] = function () {
      return {
        ...
        dynamicPushState: !0,
        forceAllDynamics: !0,
        parser_force_no_merge_selectors: [{ value: ".themeProfileMenu" }],
      };
    });
  var ot = [
    ...
    { from: "exceptions", to: "excluded_blocks", func: nt },
    { from: "whiteList", to: "whitelist", func: nt },
    ...
    return (
      t.switchers &&
        ...
        t.switchers.length &&
          ...
          (t.switchers = t.switchers.map(at))),
  ...
  function lt(e) {
    ...
    var t = e.api_key.split("wg_").pop(),
      n = it(e);
    return (function (e) {
      if ("proxy-editors.weglot.com" === window.location.hostname)
        return fetch(
  ...
  function ut() {
    ...
    if (e)
      try {
        ...
        delete t.settings, t && (ct.injectedData = t);
      } catch (e) {}
  }
  function dt(e) {
    if (e.deleted_at)
    ...
    e.injectedData ||
      ...
      (e.subdomain = !e.subdirectory && (e.subdomain || ct.is_connect)),
      e.dynamic &&
        (e.dynamics ||
    ...
    var t,
      n,
      r,
      a = e.technology_name || ct.technology_name,
      o = (t = a) && tt[t] ? tt[t]() : {},
      i = Object.assign({}, oe, o);
    if (
      (Object.assign(ct, i, e),
      ...
      ct.button_style &&
        ct.button_style.custom_css &&
        he(ct.button_style.custom_css, "weglot-custom-style"),
      ct.switchers && 0 !== ct.switchers.length
        ? (ct.switchers = ct.switchers.map(function (e) {
            var t = e.button_style,
              n = st(e, ["button_style"]);
            return Object.assign({}, { style: n.style || t }, n);
          }))
        : (ct.switchers = [
            { style: ct.button_style, location: {}, default: !0 },
          ]),
      ct.cache && location.hostname === $ && (ct.cache = !1),
      ct.api_key.length < 36 && (ct.translation_engine = 1),
      ct.excluded_blocks_remove &&
        (ct.excluded_blocks = ct.excluded_blocks.filter(function (e) {
          return !ct.excluded_blocks_remove.includes(e.value);
        })),
      ct.dangerously_force_dynamic &&
        (ct.dynamics = ct.dynamics.concat(
          ct.dangerously_force_dynamic.split(",").map(function (e) {
            return { value: e.trim() };
          })
        )),
      (ct.excluded_blocks = ct.excluded_blocks.filter(function (e) {
      ...
      (ct.dynamics = ct.dynamics.filter(function (e) {
        return we(e.value);
      })),
      (ct.is_tld = !1),
      o.forceDisableConnect && (ct.is_connect = !1),
      ct.is_connect)
    ) {
      var s = ct.host.split("www.").pop();
      ct.is_tld = ct.languages.some(function (e) {
  ...
  function vt(e) {
    if (e && e.toLowerCase) {
      var t = e.toLowerCase(),
        n = ft.languages.find(function (e) {
          var n = e.language_to,
            r = e.custom_code;
  ...
  !(function (e) {
    ...
    var t = Object.keys(gt).filter(function (e) {
      return !gt[e];
    });
    if (t.length) {
      !(function (e, t, n) {
  ...
  function _t(e) {
    ...
    var a = e || vt(We());
    if (void 0 !== yt[a] && yt.currentLang === a) return yt[a];
    var o = decodeURI("" + n + r);
    return (
      (yt.currentLang = a),
      ft.injectedData &&
        ft.injectedData.originalPath &&
        (o = n = ft.injectedData.originalPath.toLowerCase()),
      t.some(function (e) {
        var t = e.type,
          r = e.value,
        ...
        var c = {
          ...
          allExcluded: !(
            !i || !(0 === i.length || i.length >= ft.languages.length)
          ),
        };
        if (i && i.length && !i.includes(a)) return !1;
        switch (t) {
          case "START_WITH":
            return 0 === o.indexOf(r) && ((yt[a] = c), !0);
          case "END_WITH":
            return (
              -1 !== n.indexOf(r, n.length - r.length) && ((yt[a] = c), !0)
            );
          case "CONTAIN":
            return -1 !== o.indexOf(r) && ((yt[a] = c), !0);
          case "IS_EXACTLY":
            return n === r && ((yt[a] = c), !0);
          case "MATCH_REGEX":
            try {
              return !!RegExp(r).test(o) && ((yt[a] = c), !0);
            } catch (e) {
              return (
                z.warn(e, {
  ...
  function Ct(e) {
    ...
    for (
      ...
      var u = l[c],
        ...
        f = d.substring(0, 2);
      if (n[d]) return n[d];
      for (var g = 0, m = kt; g < m.length; g += 1) {
        var p = m[g],
          h = p.codes,
          v = p.pattern,
          w = h.find(function (t) {
  ...
  function xt(e) {
    ...
    return n && n.custom_local_name
      ...
      : n && n.custom_name
      ? n.custom_name
      : t === ft.language_from && ft.language_from_custom_name
      ? ft.language_from_custom_name
      : Et[t].name;
  }
  function St() {
    var e = Fe().getItem(U);
    if (e && bt().includes(e)) return e;
  }
  var Lt = function (e) {
      return e && Fe().setItem(U, e);
    },
    At = [
      {
  ...
  if (jt.getItem(G))
    try {
      (Ot = JSON.parse(jt.getItem(G))),
        Object.keys(Ot).forEach(function (e) {
          Object.keys(Ot[e]).forEach(function (t) {
            if (2 === t.length) {
              Tt[t] || (Tt[t] = {});
              var n = Ot[e][t];
              Tt[t][n] = e;
  ...
  var Rt = function () {
    return Ot && jt.setItem(G, JSON.stringify(Ot));
  };
  var Pt,
    Mt,
    qt,
  ...
  function Ut(e) {
    for (var t = [], n = 0, r = e; n < r.length; n += 1) {
      var a = r[n];
      -1 === Wt.indexOf(a) && t.push(a);
    }
    return [].push.apply(Wt, t), t;
  }
  function Ft(e) {
    void 0 === e && (e = Wt);
    for (var t = [], n = {}, r = 0, a = e; r < a.length; r += 1)
        ...
        ((n = (function (e, t) {
          ...
          return (
            e.forEach(function (e) {
              var o = It(e.w);
              o && o[t] ? (n.push(o[t]), r.push(me(e.w))) : a.push(e);
            }),
        ...
        [].push.apply(
          ...
          (function () {
            ...
            return Object.keys(Ot)
              .filter(function (t) {
                return Ot[t].createdTime + 216e5 < e;
              })
              .map(function (e) {
                return { t: Ot[e].t, w: e };
              });
    ...
    return i.length
      ? ((e.words = i),
        (e.request_url = (function () {
          var e = (function () {
            if (window.location.hostname === $) return new URL(je.url);
            var e = ft.technology_name,
              t = ft.injectedData;
            if (e === X) return new URL(window.location.href);
            ...
            var n = 0,
              r = At.filter(function (e) {
                return e.condition.some(function (e) {
                  var t = e.type,
                    n = e.payload;
                  return "TECHNOLOGY_ID" === t && n === ft.technology_id;
                });
              });
            n < r.length;
            n += 1
        ...
        (function (e) {
          var t = (ft.versions && ft.versions.translation) || 1,
            n = ["api_key=" + ft.api_key, "v=" + t],
            r =
              "https://" +
              (ft.bypass_cdn_api ? "api.weglot.com" : "cdn-api-weglot.com") +
              "/translate?" +
              n.join("&");
          return fetch(r, { method: "POST", body: Gt(JSON.stringify(e)) })
            .then(Jt)
            .then(function (e) {
              return e.json();
            })
  ...
  function Yt(e, t, n) {
    ...
    var r = { l_from: ft.language_from, l_to: t, words: e };
    return n.title && (r.title = document.title), $t(r, n);
  }
  function Vt(e, t) {
    if ("string" != typeof e || "function" != typeof t) return !1;
    var n = We();
    return n === ft.language_from
      ? (t(e), !1)
      : ($t(
          { l_from: n, l_to: ft.language_from, words: [{ t: 2, w: e }] },
          { cdn: !0, search: !0 }
        )
          .then(function (e) {
  ...
  function Zt(e, t) {
    if ((void 0 === t && (t = document.documentElement), e && !e.ready)) {
      var n = e.style || e.button_style,
        r = Un(!1, n);
      if (
        ((r.weglotSwitcher = e), Xt.push(r), !e.location || !e.location.target)
      )
        return (
      ...
      var a = ue(t, e.location.target);
      if (a) {
        if (
          (r.setAttribute("data-switcher-id", String(++Qt)),
          (r.id = "weglot-switcher-" + Qt),
          r.setAttribute("data-switcher-style-opt", JSON.stringify(n)),
          e.location.sibling)
        ) {
          var o = ue(t, e.location.sibling);
          try {
            a.insertBefore(r, o);
          } catch (e) {
            a.contains(o) ||
  ...
  function tn(e) {
    if (
      (void 0 === e && (e = document), !(bt().length < 2 || ft.hide_switcher))
    ) {
      ...
      (function (e) {
        if (
          ...
          0 !==
            le(e, 'a[href^="#Weglot-"],a[href*="change-language.weglot.com/"]')
              .length)
        ) {
          for (
            var t = bt(),
                    ...
                    var c = function () {
                        ...
                        e.setAttribute(H, ""),
                          ...
                          e.addEventListener("click", function (e) {
                            e.preventDefault(), e.stopPropagation(), On(t);
                          });
                      },
                      l = 0,
                      u = o;
      ...
      if (n.length) {
        for (var r = 0, a = n; r < a.length; r += 1) {
          var o = a[r];
          o.parentNode.insertBefore(Un(!1, ft.button_style, !0), o), ge(o);
        }
        en();
      }
      if (
        (ft.switchers &&
          ft.switchers.filter(function (e) {
            return !e.default && Zt(e, t);
          }).length &&
          en(),
        !Pt && !Mt)
      ) {
        var i =
          ft.switchers.find(function (e) {
            return e.default;
          }) || ft.button_style;
        qt = setTimeout(function () {
          (Mt = Zt(i)), Oe("switchersReady", We());
        });
      }
    }
  }
  Ne(
    ...
    function () {
      Xt.forEach(function (e) {
        ...
        (Mt = null),
        (Qt = 0),
        (ft.button_style.ready = !1),
        ft.switchers.map(function (e) {
          return (e.ready = !1);
        }),
        tn();
    },
  ...
  function rn() {
    var e = ["name", "value"];
    ft.translate_event.forEach(function (t) {
      for (
        var n = le(document.body, t.selector),
          r = function () {
            var n = o[a];
  ...
  try {
    var an = Element.prototype.attachShadow;
    Element.prototype.attachShadow = function (e) {
      var t = an.call(this, e);
      return on([this]), t;
    };
  } catch (e) {}
  function on(e) {
    ...
    for (var t = 0, n = e; t < n.length; t += 1) {
      ...
      if (r.shadowRoot && !r.shadowRoot.wgTranslated) {
        (r.shadowRoot.wgTranslated = !0), vn(r.shadowRoot);
        var a = zt(r.shadowRoot);
        a.length && (Ut(a), _n(a));
      }
    }
  }
        ...
        tn(e),
          ...
          ft.subdomain &&
            (function (e) {
              ...
              for (var n = 0, r = e; n < r.length; n += 1)
                for (
                  var a = r[n], o = 0, i = le(a, "[href]");
                  o < i.length;
                  o += 1
                ) {
                  var s = i[o];
                  if (!de(s, "[data-wg-notranslate]")) {
                    var c = s.getAttribute("href");
                    c &&
                      c.includes("//" + ft.host) &&
                      s.setAttribute("href", c.replace(ft.host, t));
                  }
                }
            })(ln),
          on(ln),
                          ...
                          return (
                            !(function (e) {
                              if (
                                ft.forceAllDynamics ||
                                (function (e) {
                                  var t = ft.dangerously_force_dynamic;
                                  if (!e || !t) return !1;
                                  if (e.closest) return de(e, t);
                                  return de(e.parentNode, t);
                                })(e)
                              )
                                return yn(e);
                              return -1 !== un.indexOf(e) || yn(e);
                            })(n) && t(n)
                          );
                        }),
                        o = 0,
    ...
    var t = e !== document ? e : e.body || e,
      n = new MutationObserver(function (t) {
        ...
        if (hn) pn(t, e);
          ...
          var r = fn.find(function (t) {
            return t.documentElement === e;
          });
          r
            ? (n = r.mutations).push.apply(n, t)
            : fn.push({ documentElement: e, mutations: [].concat(t) });
        }
      });
    n.observe(t, {
      childList: !0,
  ...
  function wn(e) {
    return (
      !(!ft.dynamics || 0 === ft.dynamics.length) &&
  ...
  function _n(e) {
    var t = We();
    if (t !== ft.language_from)
      return Yt(Ft(e), t, { title: !1, cdn: !0, nodes: e }).then(function (n) {
        return Ht(n, t, e);
      });
  }
  function bn(e) {
  ...
  function En(e) {
    clearInterval(e), ge(fe("wg_progress"));
  }
  var xn = [];
  function Sn(e) {
    if (e.data) {
      ...
      if (n) {
        if ("Weglot.iframe" === n) {
          var a = { message: "Weglot.setLanguage", payload: We() };
          return e.source.postMessage(a, e.origin), void xn.push(e.source);
        }
        "Weglot.setLanguage" !== n || On(r);
      }
    }
  }
  function Ln(e) {
  ...
  function Nn(e, t, n) {
    if (n || !e || window.top !== window || !jn(e)) {
      ...
      if (
        (e && t && !a && Lt(e),
        !ft.is_connect || ft.dynamicPushState || (!a && e !== ft.language_from)
          ? (function (e) {
              void 0 === e && (e = !0);
              var t = ft.excluded_blocks,
                n = ft.is_connect;
              if ((hn = e))
                if (
                  ((cn =
                    ...
                    var r = function () {
                        var e = o[a],
                          ...
                          r = function () {
                            ...
                            e.length > 0 && (pn(e, n), setTimeout(r, 0));
                          };
                        r();
                      },
                      a = 0,
          ...
          : (function () {
              if (0 !== gn.length) {
                for (var e = 0, t = gn; e < t.length; e += 1) t[e].disconnect();
                fn = [];
              }
            })(),
        n || a)
        ...
        (ft.is_connect && !a && Ee("onConnectPageLoad", e),
        ft.force_translation)
      ) {
        for (var o = [], i = 0, s = r; i < s.length; i += 1) {
          var c = s[i];
          ((c.closest && c.closest(ft.force_translation)) ||
            (!c.closest &&
              c.parentNode &&
              c.parentNode.closest &&
              c.parentNode.closest(ft.force_translation))) &&
            o.push(c);
        }
        _n(o);
      }
      (a && !a.language_button_displayed && a.allExcluded) || tn(),
        a ||
          (ft.remove_unused_link_hooks &&
            (function () {
              var e = bt(),
                t = ft.languages
                  .map(function (e) {
              ...
              1 === e.length && t.push(ft.language_from);
              for (
                var n = t
                    .map(function (e) {
                      return Kt(e);
          ...
          rn(),
          (function () {
            window.addEventListener("message", Sn, !1);
            var e = ft.translate_iframes;
            if (e)
              for (var t = 0, n = le(document.body, e); t < n.length; t += 1) {
                var r = n[t];
                r.contentWindow && xn.push(r.contentWindow);
              }
            Ce("onPageLanguageSet", Ln),
              "with-window-top" === An() &&
          ...
          ["alert"].forEach(function (e) {
            ...
            window[e] = function () {
              ...
              if ("string" == typeof arguments[0]) {
                var n = We();
                return ft.language_from === n
                  ? t.apply(window, arguments)
                  : Yt([{ t: 2, w: arguments[0] }], n, {
                      title: !1,
                      cdn: !0,
                    }).then(function (n) {
      ...
      Yt(Ft(), e)
        .then(function (n) {
          kn(),
            Ht(n, e),
            document.documentElement.setAttribute("lang", e),
            Oe("languageChanged", e, t || ""),
            ft.loading_bar && En(r);
        })
        .catch(function (e) {
          throw (ft.loading_bar && En(r), kn(), Fe().removeItem(U), e);
        }),
        Ee("onPageLanguageSet", e);
    }
  }
  function jn(e) {
    return (
      ...
      (ft.host &&
      !(function () {
        if (ft.subdirectory) return [ft.host, $];
        return ft.languages
          .map(function (e) {
            return (
  ...
  function Dn(e) {
    return (function (e, t, n) {
      ...
      if (t.language_from === e) return t.language_from_custom_flag || In(e, n);
      var r = e.toLowerCase(),
      ...
      return a ? a.custom_flag || In(a.language_to, n) : "";
    })(e, ft, Et);
  }
  Ne(
    "initialized",
    function () {
      ft.translate_search &&
        ...
        (function () {
          for (
            var e = ft.search_forms,
              t = ft.search_parameter,
              n = 0,
              r = le(document, e);
            n < r.length;
            n += 1
            ...
            -1 !== window.location.search.indexOf(t + "=") &&
              a.elements &&
              a.elements[t] &&
              (o = Se.get("wg-search-form")) &&
              (a.elements[t].value = o);
          }
          Se.erase("wg-search-form");
        })();
    },
    !0
  );
  ...
  function Bn(e) {
    if (e === ft.language_from) {
      ...
      t.setTime(t.getTime() + 2592e6),
        Fe({ type: "cookie" }).setItem("WG_CHOOSE_ORIGINAL", "1", {
          expires: t.toUTCString(),
        });
    } else Fe({ type: "cookie" }).removeItem("WG_CHOOSE_ORIGINAL");
  }
  function Un(e, t, n) {
    var r;
    void 0 === e && (e = !1),
      void 0 === t && (t = ft.button_style),
      void 0 === n && (n = !1);
    var a = t.full_name;
    void 0 === a && (a = !0);
    var o = t.with_name;
    ...
    void 0 === l && (l = !1);
    var u =
        /background-position/i.test(ft.button_style.custom_css) &&
        !ft.languages.some(function (e) {
          return e.custom_flag;
        }),
      d = s || "rectangle_mat",
      f = u ? ["flag-" + ie.indexOf(d), "legacy"] : [],
    ...
    (p.className = "weglot_switcher " + h + " country-selector closed"),
      ft.switcher_editor && (p.className += " wg-editor");
    var v,
      w = function () {
    ...
    p.addEventListener("click", function (e) {
      ...
      p.addEventListener("keydown", function (e) {
        if (e.keyCode !== Rn) {
          if (e.keyCode === qn || e.keyCode === Mn)
            return e.preventDefault(), void N(e.keyCode);
          e.keyCode === Pn && zn(p) && (e.preventDefault(), _(), p.focus());
        } else {
    ...
    if (o) {
      var S = a ? xt(C) : C.toUpperCase();
      E.appendChild(document.createTextNode(S));
    } else E.setAttribute("aria-label", xt(C));
    ...
    A.setAttribute("role", "none"),
      bt().forEach(function (e) {
        ...
        if (e !== C || (!i && !c)) {
          ...
          } else n.setAttribute("aria-label", xt(C));
    ...
    var N = function (e) {
      var t = e === qn ? "nextSibling" : "previousSibling",
        n = w();
      if (v && zn(p))
        v[t]
    ...
    Yn = function () {
      ...
      if (
        !(
          ...
          ft.subdirectory ||
          n ||
          Fe({ type: "cookie" }).getItem("WG_CHOOSE_ORIGINAL") ||
          ve() ||
          t === $
        )
      ) {
        ...
        return r && !_t(r)
          ? r
          : ft.auto_switch_fallback && !_t(ft.auto_switch_fallback)
          ? ft.auto_switch_fallback
          : void 0;
      }
      n && Bn(We());
    },
  ...
  function Xn() {
    if (ft.api_key) {
      z.initialize(!ft.remove_logging),
        Ne(
          "initialized",
          function () {
            ft.page_views_enabled &&
              (ft.is_connect
                ? Xe(ft.language_from, function (e) {
                    return Vn(e);
                  })
                : Vn());
          },
      ...
      if ((Ee("onWeglotSetup"), !tr.initialized || window.Turbolinks)) {
        ($n = (function () {
          var e = bt();
          if (ft.is_connect) {
            var t =
              document.documentElement.dataset.wgTranslated ||
              (ft.subdirectory ? qe() : Me());
            if (t !== ft.language_from) return t;
            var n = Yn();
            return t === ft.language_from && n && e.includes(n)
              ? n
              : ft.language_from;
          }
          var r = pe("lang");
          if (r && e.includes(r)) return (Kn = !0), r;
          var a = St();
          if (a && e.includes(a)) return a;
          var o = Yn();
          if (o && e.includes(o)) return (Kn = !0), o;
          return ft.language_from;
        })()),
          We();
        var e = _t();
        if (
          ((Gn =
            $n &&
            $n !== ft.language_from &&
            document.documentElement.dataset.wgTranslated !== $n &&
            !e &&
            !document.documentElement.dataset.wgExcludedUrl &&
            !ft.switcher_editor) && ft.wait_transition
            ? he(
          ...
          case "Weglot.detect":
            e.source.postMessage(
              JSON.stringify({
                ...
                data: { initialized: tr.initialized, options: ft },
              }),
              e.origin
            );
            break;
  ...
  var tr = window.Weglot || {
    ...
    off: function (e, t) {
      var n,
        r = !1,
        a = function (t) {
          return Le[t].name === e && !Le[t].internal;
        };
      n =
        "function" == typeof t
          ? function (e) {
              return a(e) && Le[e].callback === t;
            }
          : function (e) {
              return a(e);
            };
      for (var o = Le.length - 1; o >= 0; o--)
        n(o) && (Le.splice(o, 1), (r = !0));
      return r;
    },
    getStoredLang: St,
    getLanguageName: xt,
  ...
  return (
    Ae(ht(), "polyfillReady", function () {
      ...
      if (n) {
        ...
        r && 0 === r.indexOf("wg_") && tr.initialize({ api_key: r });
      }
    }),
    tr
  );
